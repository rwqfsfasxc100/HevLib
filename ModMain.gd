...
var tags = {
	"MainWeaponSlot":{"type":"HARDPOINT"},
	"MainLowWeaponSlot":{"type":"HARDPOINT"},
	"LeftHighStress":{"type":"HARDPOINT"},
	"RightHighStress":{"type":"HARDPOINT"},
	"LeftWeaponSlot":{"type":"HARDPOINT"},
	"MiddleLeftWeaponSlot":{"type":"HARDPOINT"},
	"RightWeaponSlot":{"type":"HARDPOINT"},
	"MiddleRightWeaponSlot":{"type":"HARDPOINT"},
	"LeftDroneSlot":{"type":"HARDPOINT"},
	"RightDroneSlot":{"type":"HARDPOINT"},
	"LeftRearSlot":{"type":"HARDPOINT"},
	"RightRearSlot":{"type":"HARDPOINT"},
	"LeftBay1":{"type":"HARDPOINT"},
	"RightBay1":{"type":"HARDPOINT"},
	"LeftBay2":{"type":"HARDPOINT"},
	"RightBay2":{"type":"HARDPOINT"},
	"LeftBay3":{"type":"HARDPOINT"},
	"RightBay3":{"type":"HARDPOINT"},
	"AmmunitionDelivery":{"type":"MASS_DRIVER_AMMUNITION"},
	"DisposableDrones":{"type":"NANODRONE_STORAGE"},
	"Propellant":{"type":"PROPELLANT_TANK"},
	"Thrusters":{"type":"STANDARD_REACTION_CONTROL_THRUSTERS"},
	"Torches":{"type":"STANDARD_MAIN_ENGINE"},
	"Rods":{"type":"FISSION_RODS"},
	"Capacitor":{"type":"ULTRACAPACITOR"},
	"Turbine":{"type":"FISSION_TURBINE"},
	"AuxilaryPower":{"type":"AUX_POWER_SLOT"},
	"CargoBay":{"type":"CARGO_BAY"},
	"Autopilot":{"type":"AUTOPILOT"},
	"Hud":{"type":"HUD"},
	"Lidar":{"type":"LIDAR"},
	"ReconDrone":{"type":"RECON_DRONE"},
}
